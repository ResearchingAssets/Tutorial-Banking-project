    ...
    <body class="body-container">
        ...
        <header class="header">
            ...
            <nav class="navbar">
                ...
                <a href="Banking.php" class="log-out-link">Log out</a>
...
<span class="balance">Balance: <span class="balance-amount"><?php echo $balance; ?></span></span>
        ...
        <section class="options">
            <div class="options-grid">
                    ...
                    <button class="grid-item" onclick="ChangeToTransactionHistory()"><span class="text">Transaction History</span></button>
                    <button class="grid-item" onclick="QuickTransfer()"><span class="text">Quick Transfer</span></button>
                    <button class="grid-item" id="center-button" onclick="ChangeToTransactionHistoryDownload()"><span class="text">Download transaction history</span></button>
        </div>
        </section>
        <section class="about">
                    <h1 class="name">
