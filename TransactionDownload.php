        ...
        <div class="tableTransaction">
            ...
            <table>
                ...
                <tbody>
                    ...
                    $stmt = $conn->prepare("SELECT TransactionDate, TransactionType, AmountOfMoney, BalanceAfter FROM transactions WHERE Username = ? ORDER BY TransactionDate DESC");
                    $stmt->bind_param("s", $username);
                    $stmt->execute();
                    $result = $stmt->get_result();
                    ?>
                    ...
                    <tr>
                        ...
                        <td><?php echo htmlspecialchars(number_format($row['BalanceAfter'], 2)); ?></td>
                    </tr>
                    <?php endwhile; ?>
                </tbody>
            </table>
            <button  class="grid-item" onclick="downloadCSV()"><span class="text">Download</span></button>
        </div>
